    ...
    return (
        <>
            ...
            <section className="success-story">
                <div className="container">
                    <div className="row align-items-center owl-carousel active-story">
                        <div className="col-12 single_stroy">
                            <div className="row">
                                <div className="col-lg-6 col-md-7">
                                    <h3 className="section-title">Story Of Success</h3>
                                    <p>I want the best in life. Binasta Products keeps me healthy and flawless. Binasta affiliate marketing program keeps my money flowing What else would I wish for in life?</p>
                                    <h4>Mary maya</h4>
                                </div>
                                <div className="col-lg-6 col-md-5 align-self-md-center">
                                    <div className="strong-man">
                                        <img src="@/assets/images/all-img/success.webp" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
