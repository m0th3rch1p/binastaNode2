...
function ProductCategories() {
  ...
  var _a = react_1.useState({
    ...
    categories: []
      ...
      categoriesState = _a[0],
      setCategoriesState = _a[1];
  ...
  react_1.useEffect(function () {
    setCategoriesState(function (state) {
  ...
  return React.createElement("div", {
  ...
  }, React.createElement("h5", null, "Product Categories"), React.createElement(ProductCategoryForm_1["default"], {
    show: categoriesState.show
    ...
    onClick: function onClick() {
      return setCategoriesState(function (state) {
        return __assign(__assign({}, state), {
          show: !categoriesState.show
        });
      });
  ...
  }), categoriesState.show ? 'Close' : 'Add Category')), React.createElement("div", {
    className: 'card-body'
