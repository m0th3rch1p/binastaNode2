import { DistributorOrder } from '@/store/reducers/distributorOrdersSlice'
import { Order } from '@/store/reducers/ordersSlice'
import React from 'react'

function OrderDetails({ order } : { order: DistributorOrder | Order }) {
  return (
    <div className="row">
        {
          order ? (
