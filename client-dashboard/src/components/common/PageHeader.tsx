            ...
            <div className="header-bar ms-auto">
                <ul className="navbar-nav justify-content-end">
                    ...
                    <li className="nav-item dropdown">
                        <a href="#" className="nav-link nav-link-notify" data-count="3" data-bs-toggle="dropdown" aria-expanded="false">
                            <i className="bi bi-cart2 icon-lg"></i>
                        </a>
                        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" style={{ margin: "0px" }}>
                    ...
                    <li className="nav-item ms-3">
                        <button className="btn btn-primary btn-icon">
                            <i className="bi bi-plus-circle"></i> Add Customers
                        </button>
                    </li>
                </ul>
            </div>
