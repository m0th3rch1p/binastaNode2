...
var EmptyCheckout_1 = require("@/components/checkout/EmptyCheckout");
function Checkout() {
    var _this = this;
    ...
    var _g = react_1.useState({
        ...
        showLoginForm: false
    }), checkoutState = _g[0], setCheckoutState = _g[1];
    ...
    var onUserFormChange = function (e) {
        setCheckoutState(function (state) {
            var _a;
            return (__assign(__assign({}, state), { userForm: __assign(__assign({}, state.userForm), (_a = {}, _a[e.target.name] = e.target.value, _a)) }));
        });
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Register User
                    if (!checkoutState.userForm.email || !checkoutState.userForm.password || !checkoutState.addressForm.address || !checkoutState.addressForm.phone_number)
                        return [2 /*return*/];
                    return [4 /*yield*/, registerUser(checkoutState.userForm).unwrap()];
                case 1:
                    response = _a.sent();
                    dispatch(userSlice_1.setAuthenticated(response.status));
                    _a.label = 2;
                case 2: return [4 /*yield*/, storeAddress(checkoutState.addressForm).unwrap()];
                case 3:
    ...
    return (cart.products.length ?
        (React.createElement("div", { className: "container mb-80 mt-50" },
                ...
                React.createElement("div", { className: "col-lg-7" },
                    !user.authenticated ? (React.createElement(React.Fragment, null,
                                ...
                                React.createElement("div", { className: "toggle_info" },
                                    React.createElement("span", null,
                                        ...
                                        React.createElement("a", { href: "#0", onClick: function (e) {
                                                e.preventDefault();
                                                setCheckoutState(function (state) { return (__assign(__assign({}, state), { showLoginForm: !state.showLoginForm })); });
                                            }, "data-bs-toggle": "collapse", className: "collapsed font-lg", "aria-expanded": "false" }, "Click here to login"))),
                                React.createElement("div", { className: "panel-collapse collapse login_form " + (checkoutState.showLoginForm ? 'show' : ''), id: "loginform" },
                        ...
                        React.createElement("div", { className: "row" },
                            ...
                            React.createElement(RegisterForm_1["default"], { form: checkoutState.userForm, onChangeFn: onUserFormChange })))) : React.createElement(React.Fragment, null),
                    React.createElement("div", { className: "row" },
                        React.createElement("h4", { className: "mb-30" }, "Delivery Details"),
                        React.createElement(Address_1["default"], { form: checkoutState.addressForm, onChangeFn: onAddressFormChange }))),
                React.createElement("div", { className: "col-lg-5" },
                    ...
                    React.createElement("div", { className: "payment ml-30" },
                        React.createElement("button", { onClick: placeOrder, className: "btn btn-fill-out btn-block mt-30", disabled: isRegisterUserLoading || isStoreAddressLoading || isStoreOrderLoading },
                            ...
                            React.createElement("i", { className: "fi-rs-sign-out ml-15" }))))))) : (React.createElement(EmptyCheckout_1["default"], null)));
}
