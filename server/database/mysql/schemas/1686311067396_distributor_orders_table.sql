CREATE TABLE IF NOT EXISTS distributor_orders(
  ...
  distributor_id BIGINT UNSIGNED NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  distributor_address_id BIGINT UNSIGNED NOT NULL REFERENCES user_addresses(id) ON DELETE SET NULL,
