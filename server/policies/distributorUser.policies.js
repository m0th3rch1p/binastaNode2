...
exports.idPolicy = exports.authPolicy = exports.registerPolicy = void 0;
const distributorUserValidations = __importStar(require("@/validations/distributorUser.validations"));
const registerPolicy = (req, res, next) => {
